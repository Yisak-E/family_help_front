...
import { helpApi, CommunityPost } from '@/services/api';
    ...
    <>
      ...
      <div className="page-header">
        <div className="container">
          <h1>📜 My Interaction History</h1>
          <p>Your posts and offers - view what you've created in the community.</p>
        </div>
      </div>
                ...
                <div className="flex justify-between items-center" style={{ flexWrap: 'wrap', gap: 12 }}>
                  <div className="flex gap-3 items-center" style={{ flexWrap: 'wrap' }}>
                    <span
                      className="badge"
                      style={{
                        background: entry.postType === 'OFFER' ? '#dcfce7' : '#ede9fe',
                        color: entry.postType === 'OFFER' ? '#166534' : '#6b21a8',
                      }}
                    >
                    ...
                    <div>
                      ...
                      {entry.description && (
                        <p className="text-sm text-muted" style={{ maxWidth: '300px' }}>{entry.description}</p>
                      )}
